...
import jmetal.util.jmathplot.ScatterPlot;
...
public class MOEAD_IEpsilon extends Algorithm {
    ...
    public SolutionSet execute() throws JMException, ClassNotFoundException {
       ...
       // runningTime = (Integer) getInputParameter("runningTime") + 1; // start from 1
        ...
        double pr = (Double) getInputParameter("pr");
       ...
       // String problemName = problem_.getName() + "_" + Integer.toString(runningTime);
        ...
        int tc_ = (int) (pr * maxEvaluations_ / populationSize_);
        ...
        do {
            ...
            for (int i = 0; i < populationSize_; i++) {
                ...
                if (crossover_.getClass().getSimpleName().equalsIgnoreCase("BlocCrossover")) {
       ...
       // SqlUtils.InsertSolutionSet(problemName, allPop);
        allPop.printVariablesToFile("tt.txt");
